        ...
        integrations = {
          ...
          markdown = {
            ...
            resolve_image_path = function(document_path, image_path, fallback)
              ...
              local same_dir = vim.fn.fnamemodify(document_path, ":h") .. "/" .. image_path
              if vim.fn.filereadable(same_dir) == 1 then
                return same_dir
              end

              -- Check in the Images folder for obsidian support
              local img_dir = vim.fn.expand("~/Documents/vochidat0/Images/") .. image_path
              if vim.fn.filereadable(img_dir) == 1 then
                return img_dir
              end
